...
pub fn generate_decl_metadata(decl: &ItemTrait, has_config: bool) -> Result<TokenStream2> {
    ...
    // Adding bounds: `TypeInfo + 'static` for any type parameter in method sigs (generic parameter and associated type).
    ...
    for item in &decl.items {
        ...
        for input in &signature.inputs {
            ...
            inputs.push(quote!(
                #xcq_extension::metadata::MethodParamMetadata {
                    name: #name,
        ...
        methods.push(quote!(
            #( #attrs )*
            #xcq_extension::metadata::MethodMetadata {
                name: #method_name,
    ...
    where_clause
        .into_iter()
        .map(|ty| parse_quote!(#ty: scale_info::TypeInfo + 'static))
    ...
    if has_config {
        Ok(quote!(
            #(#attrs)*
            #[inline(always)]
            pub fn extension_metadata #impl_generics () ->  #xcq_extension::metadata::ExtensionMetadata
            #where_clause
            {
                #xcq_extension::metadata::ExtensionMetadata {
                    name: #trait_name,
                    methods: scale_info::prelude::vec![ #( #methods, )* ],
                }
            }
        ))
    } else {
        Ok(quote!(
            #(#attrs)*
            #[inline(always)]
            pub fn extension_metadata() -> #xcq_extension::metadata::ExtensionMetadata {
                #xcq_extension::metadata::ExtensionMetadata {
                    name: #trait_name,
                    methods: scale_info::prelude::vec![ #( #methods, )* ],
                }
...
pub fn generate_impl_metadata(impls: &[ItemImpl]) -> Result<TokenStream2> {
    ...
    let mut extension_metadata_list = Vec::new();
    ...
    for impl_ in impls {
        ...
        extension_metadata_list.push(quote!(
            #( #attrs )*
            #trait_::extension_metadata::#generics()
        ));
        extension_ids.push(quote!(#extension_trait_full_path));
    }

    let query_metadata_by_extension_id = quote! {
        impl #xcq_extension::ExtensionImplMetadata for #extension_impl_name {
            fn extension_metadata(extension_id: #xcq_extension::ExtensionIdTy) -> #xcq_extension::metadata::ExtensionMetadata {
    ...
    let aggregate_metadata = quote! {
        impl #extension_impl_name {
            pub fn metadata() -> #xcq_extension::metadata::Metadata {
                #xcq_extension::metadata::Metadata::new(
                    scale_info::prelude::vec![ #( #extension_metadata_list, )* ],
                )
            }
        }
    };

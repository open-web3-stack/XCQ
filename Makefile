...
poc-guests: poc-guest-sum-balance poc-guest-sum-balance-raw poc-guest-total-supply poc-guest-transparent-call

dummy-poc-guests: dummy-poc-guest-sum-balance dummy-poc-guest-sum-balance-raw dummy-poc-guest-total-supply dummy-poc-guest-transparent-call

...
pub fn generate_decl_metadata(decl: &ItemTrait, has_config: bool) -> Result<TokenStream2> {
    ...
    for item in &decl.items {
        ...
        for input in &signature.inputs {
            ...
            inputs.push(quote!(
                #pvq_extension::metadata::MethodParamMetadata {
                    name: #name,
        ...
        methods.push(quote!(
            #( #attrs )*
            #pvq_extension::metadata::MethodMetadata {
                name: #method_name,
    ...
    if has_config {
        Ok(quote!(
            #(#attrs)*
            #[inline(always)]
            pub fn extension_metadata #impl_generics () ->  #pvq_extension::metadata::ExtensionMetadata
            #where_clause
            {
        ...
        Ok(quote!(
            #(#attrs)*
            #[inline(always)]
            pub fn extension_metadata() -> #pvq_extension::metadata::ExtensionMetadata {
                #pvq_extension::metadata::ExtensionMetadata {
                    name: #trait_name,
                    methods: scale_info::prelude::vec![ #( #methods, )* ],
                }
...
pub fn generate_impl_metadata(impls: &[ItemImpl]) -> Result<TokenStream2> {
    ...
    for impl_ in impls {
        ...
        // Implementation traits are always references with a path `impl pvq_extension::ExtensionCore<generics> ...`
